...
import com.myyteam.shesg.infrastructure.persistence.ShortUrlAssembler;
...
public class ShortUrlServiceImpl implements ShortUrlService {
    ...
    public ShortUrlVO generateShortLink(String userId, String url) {
        ...
        if (StringUtils.isNotBlank(url) && ((url.contains(Constants.GATE_PRE)) || url.contains(Constants.SHESG_PRE))) {
            ...
            String codeId = IdUtil.getSnowflakeNextIdStr();
            ...
            return ShortUrlAssembler.INSTANCE.toVO(shortUrlDO);
        } else {
